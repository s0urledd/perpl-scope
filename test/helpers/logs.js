...
export const ev = {
  ...
  // By default the removed deposit equals the loss (no margin left, no fee).
  liquidation: (perpId, accountId, side, liqPNS, liqLot, remaining, pnl, extra = {}) => ['PositionLiquidated', { perpId: BigInt(perpId), accountId: BigInt(accountId), posAccountId: BigInt(accountId), positionType: side, markPricePNS: liqPNS, liqPricePNS: liqPNS, liqLotLNS: liqLot, posLotLNS: remaining, deltaPnlCNS: pnl, fundingCNS: 0n, posAmountCNS: pnl, posDepositCNS: 0n, accAmountCNS: 0n, accBalanceCNS: 0n, onOrderBook: false, ...extra }],
